...
optimized_routes = [
    (stations_with_coords["Centru"], stations_with_coords["Autogara"]),
    (stations_with_coords["Centru"], stations_with_coords["Cartier Nord"]),
    (stations_with_coords["Centru"], stations_with_coords["Cartier Sud"]),
    (stations_with_coords["Mall"], stations_with_coords["Cartier Nord"]),
...
<div style="position: fixed; 
    ...
    <span style="color:green;">▬</span> Trasee Disponibile<br>
</div>
"""
route_map.get_root().html.add_child(folium.Element(legend_html))

optimized_route_output_path = "/home/rares/bacau_routes_map.html"
